...
window.I18N = {
  de: {
    ...
    "meta.description": "95 m² mit Meerblick in Radazul, Teneriffa. Saisonmiete 1–3 Monate für Überwinterer, Remote Worker und Sabbaticals. Direkt vom Eigentümer, ab sofort frei.",
    "og.title": "Vivienda Radazul — Saisonmiete 1–3 Monate",
    "og.description": "95 m² Meerblick · 3 SZ · 25 m zum Atlantik · ab sofort frei",

    "topbar.mark.suffix": "· Saisonmiete",
    "topbar.available": "Ab sofort frei",
    ...
    "eck.lead": "Die wichtigsten Zahlen auf einen Blick.",
    "eck.size.k": "Größe",
    ...
    "gal1.lead": "Wohnzimmer, offene Küche, Terrasse mit Atlantikblick, voll möbliert.",
    "gal1.cap1": "Terrasse · Atlantikblick",
    "gal1.cap2": "Wohnzimmer · Palmen-Prints",
    "gal1.cap3": "Terrasse · Lounge-Sessel",
    "gal1.cap4": "Wohn-Essbereich",
    "gal1.cap5": "Essbereich · Esstisch",
    "gal1.cap6": "Deko · Vasen & Wandteller",
    "gal1.cap7": "Küche · Bartheke",
    "gal1.cap8": "Küche · Detail",
    "gal1.cap9": "Blick zur Terrasse",
    "gal1.cap10": "Wohnzimmer · TV-Ecke",
    "gal1.foot": "Galerie I · 10 Bilder",
    ...
    "lage.p2": "Der Spielplatz liegt direkt nebenan, Restaurants in wenigen Gehminuten. Der nächste Supermarkt ist 10 Minuten zu Fuß. Die TF-1 Autobahn liegt 2 Minuten weg, die Anbindung in alle Richtungen ist schnell.",
    ...
    "proc.1.p": "Per WhatsApp mit deinem Wunsch-Zeitraum und dem Anlass deines Aufenthalts (Überwintern, Remote Work, Sabbatical, Genesung).",
    ...
    "proc.4.p": "Zwei Monatsmieten, vor Mietbeginn. Wird nach Auszug zurückerstattet, abzüglich eventueller Schäden.",
    ...
    "proc.foot": "<em>Keine Online-Buchung. Keine Plattform-Gebühren. Direkter Kontakt zum Eigentümer — wir wohnen nebenan.</em>",
  ...
  en: {
    ...
    "meta.description": "95 m² apartment with sea view in Radazul, Tenerife. Seasonal rental 1–3 months for winter residents, remote workers and sabbaticals. Directly from the owners, available now.",
    "og.title": "Vivienda Radazul — Seasonal rental 1–3 months",
    "og.description": "95 m² sea view · 3 bedrooms · 25 m to the Atlantic · available now",

    "topbar.mark.suffix": "· Seasonal rental",
    "topbar.available": "Available now",
    ...
    "eck.lead": "The numbers that matter, at a glance.",
    "eck.size.k": "Size",
    ...
    "gal1.lead": "Living room, open kitchen, terrace with Atlantic view, fully furnished.",
    "gal1.cap1": "Terrace · Atlantic view",
    "gal1.cap2": "Living room · Palm prints",
    "gal1.cap3": "Terrace · Lounge chair",
    "gal1.cap4": "Living-dining area",
    "gal1.cap5": "Dining area · Table",
    "gal1.cap6": "Decor · Vases & wall plates",
    "gal1.cap7": "Kitchen · Breakfast bar",
    "gal1.cap8": "Kitchen · Detail",
    "gal1.cap9": "View to the terrace",
    "gal1.cap10": "Living room · TV corner",
    "gal1.foot": "Gallery I · 10 images",
    ...
    "lage.p2": "The playground is right next door, restaurants are a few minutes away on foot. The nearest supermarket is 10 minutes on foot. The TF-1 motorway is 2 minutes away — quick access in every direction.",
    ...
    "lage.dist.3v": "10 min on foot",
    "lage.dist.4k": "Restaurants",
    "lage.dist.4v": "3–8 min on foot",
    "lage.dist.5k": "Playground",
    "lage.dist.5v": "1 min on foot",
    ...
    "proc.1.p": "By WhatsApp with your desired dates and the purpose of your stay (overwintering, remote work, sabbatical, recovery).",
    ...
    "proc.4.p": "Two months' rent, before your move-in. Refunded after move-out, minus any damages.",
    ...
    "proc.foot": "<em>No online booking. No platform fees. Direct contact with the owner — we live next door.</em>",
